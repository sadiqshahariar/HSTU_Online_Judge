...
$s1=mysqli_query($conn,$ac);
$s2=mysqli_query($conn,$wa);
$s3=mysqli_query($conn,$tle);
 ...
 <div class="pc">Information</div>
   ...
   <table class="table">
    ...
    <?php
     ...
     if($data==$_SESSION['un'])
     {
        echo "<tr class=\"warning\"><td><a href=\"#?name=$username\">Edit Profile</a></td></tr>";
     }
  ...
  <div class="table-responsive">
   ...
   <ul class=\"nav nav-pills nav-stacked\">
    <li role=\"presentation\" class=\"active\"><a href=\"#\">Create Contest</a></li>
    <li role=\"presentation\"><a href=\"#\">Create Contest Problem</a></li>
...
<!--<div class="ym">
 <div class="pc">Dashboard</div>
   ...
   <ul class="nav nav-pills nav-stacked">
    <li role="presentation" class="active"><a href="#">Create Contest</a></li>
    <li role="presentation"><a href="#">Create Contest Problem</a></li>
    <li role="presentation"><a href="setproblem.php">Create ProblemSet</a></li>
